	...
	public static function publicMapContent($core,$_ctx,$aElements = array())
	{
		...
		if ($s->myGmaps_enabled && ($isTemplateTag || self::hasMap($sPostId) != '') ) {
			...
			foreach ($map_elements as $map_element_id => $map_element) {
				...
				$sTemplate .= 
				'var title_'.$map_element_id.' = "'.html::escapeHTML($map_element['post_title']).'";'."\n".
				'var content_'.$map_element_id.' = \''.$content.'\';'."\n";
				...
				if ($type == 'point of interest') {
					...
					'marker = new google.maps.Marker({'."\n".
						...
						'title: title_'.$map_element_id.','."\n".
						'map: map_'.$sPostId."\n".
					'});'."\n".
					'google.maps.event.addListener(marker, "click", function() {'."\n".
						'openmarkerinfowindow(this,title_'.$map_element_id.',content_'.$map_element_id.');'."\n".
					'});'."\n";
					$has_marker = true;
				} 
				elseif ($type == 'polyline') {
					...
					'google.maps.event.addListener(polyline, "click", function(event) {'."\n".
						...
						'openpolyinfowindow(title_'.$map_element_id.',content_'.$map_element_id.',pos);'."\n".
					'});'."\n";
					$has_poly = true;
